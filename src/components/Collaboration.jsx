      ...
      <div className='container lg:flex'>
        <div className='max-w-[25rem]'>
          <h2 className='h2 mb-4 md:mb-8'>
            AI class App for seamless Collaboration
          </h2>
        ...
        <div className='lg:ml-auto xl:w-[38rem] mt-4'>
          ...
          <div className='mt-3 relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale-75 md:scale-100'>
