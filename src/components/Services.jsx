        ...
        <div className='relative'>
          ...
          <div className='relative z-1 grid gap-5 lg:grid-cols-2'>
            <div className='relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden'>
                ...
                <div className='absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b-from-n-8/90 to-n-8/90 lg:p-15'>
              <h4 className='h4 mb-4'>Photo Editing</h4>
              <p className='body-2 mb-[3rem] text-n-3'>Automatically enhance your photos using our AI app photo editing feature. Try it now</p>
              </div>
              <PhotChatMessage/>
            </div>
